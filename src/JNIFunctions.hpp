...
class JNIFunctions {
    public:
        static constexpr std::array<const char*, 233> jni_function_names = {
            /* 0-3 reserved */ "reserved0", "reserved1", "reserved2", "reserved3",
            ...
            "GetFieldID", "GetObjectField", "GetBooleanField", "GetByteField",
            "GetCharField", "GetShortField", "GetIntField", "GetLongField",
            "GetFloatField", "GetDoubleField", "SetObjectField", "SetBooleanField",
            "SetByteField", "SetCharField", "SetShortField", "SetIntField",
            "SetLongField", "SetFloatField", "SetDoubleField", "GetStaticMethodID",
            ...
            "GetLongArrayElements", "GetFloatArrayElements", "GetDoubleArrayElements",
            ...
            "GetObjectRefType" // optional JNI 1.6+
        };
        static_assert(jni_function_names.size() == 233, "Update JNI function list"); // or whatever the actual count
};
